...
const Gallery = () => {
    return (
        <div>
            <>
                <h3 className='justify-center flex  mb-7 text-3xl font-semibold text-slate-600'> <AiOutlineFileImage className='text-red-700 h-10 w-12 mr-2' />Gallery Collections</h3>
            </>
